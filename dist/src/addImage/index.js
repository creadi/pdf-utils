...
exports.default = (function (tempFolder, _a, path) {
    var height = _a.height, imagePath = _a.imagePath, page = _a.page, width = _a.width, x = _a.x, y = _a.y;
    return __awaiter(void 0, void 0, void 0, function () {
        var id, imageBase64, overlayBuffer, overlay, resultFile, result, _b, pageSelected, pagesAfter, pagesBefore, fixed, buffer;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    id = uuid_1.v4();
                    return [4 /*yield*/, getImage_1.default(imagePath)];
                case 1:
                    imageBase64 = _c.sent();
                    return [4 /*yield*/, createOverlay_1.default(imageBase64, width, height, x, y)];
                case 2:
                ...
                case 7: return [4 /*yield*/, utils_1.extractPage(path, page, tempFolder)];
                case 8:
